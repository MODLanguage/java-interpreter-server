...
public class InterpreterTest {
    ...
    public void testBadModl() {
        try {
            ...
            assertEquals(e.getStatus()
                    .value(), 400);
            assertEquals("400 BAD_REQUEST \"Error processing the supplied MODL string: uk.modl.parser.errors.InterpreterError: Parser Error: line 1:3 no viable alternative at input 'a=b]'\"", e.getMessage());
        }
    }
    ...
    public void testTimeout() {
        try {
            ...
            assertEquals(e.getStatus()
                    .value(), 400);
            assertEquals("400 BAD_REQUEST \"Internal Error processing the supplied MODL string. Try simplifying your MODL.\"", e.getMessage());
        }
    }
